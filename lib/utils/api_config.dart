class ApiConfig {
  ...
  static const String baseUrl = 'http://10.0.2.2:3000';// 'http://backmicroguard.onrender.com/' para desarrollo prod emulador android

  // Endpoints de usuario
  static const String registro = '$baseUrl/usuario/crear';
